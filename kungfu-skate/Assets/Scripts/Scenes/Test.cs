...
public class Test : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(Input.GetKeyUp(KeyCode.Keypad0)) StartCoroutine(spawner.spawnNinjaLineRoutine(190, 45, 140, 45, 4, 0, -40, 0.5f, 1, 1.5f, "top", true, 1, 1));
        if(Input.GetKeyUp(KeyCode.Keypad1)) StartCoroutine(spawner.spawnNinjaLineRoutine(190, -90, 140, -90, 4, 0, +40, 0.5f, 1, 1.5f, "bot-right", true, 1, 2));
        if(Input.GetKeyUp(KeyCode.Keypad2)) StartCoroutine(spawner.spawnNinjaLineRoutine(190, -90, 140, -90, 4, 0, +40, 0.5f, 1, 1.5f, "bot-left", true, 1, 2));
        if(Input.GetKeyUp(KeyCode.Keypad3)) StartCoroutine(spawner.spawnNinjaLineRoutine(190, 45, 140, 45, 4, 0, -40, 0.5f, 0, 4, "right", true));
    }
